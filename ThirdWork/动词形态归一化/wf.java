...
public class wf {
    ...
    public static void printWords(File verb, File stop, File f, int n1, int n2){
        if(n2 != -1)//输出短语
        {
            printPhrase(f, n1, n2);
        }
                    ...
                    while((ch = br.read()) != -1)
                    {
                        ...
                        if(c < 'a' || c > 'z')
                        {
                            ...
                            if(flag == 2)//需要改变动词形态
                            {
                                for(int i = 0; i<l; i++)
                                {
                                    if(Arrays.asList(verbArray[i]).contains(s))
                                    {
                                        s = verbArray[i][0];
                                        break;
                                    }
    ...
    public static void printWordsInDir(File verb, File stop, File f, int n1, int n2){
    ...
    public static void printWordsInDir_recursive(File verb, File stop, File f, int n1, int n2){
